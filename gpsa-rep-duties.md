---
title: GPSA Representative Duties
toc: true
...
For official rules, see the [GPSA Rulebook - Officials](https://rulebook.gpsaswimming.org/officials.html) section.
...
- See [Roster Submittal Process](roster-submittal.md) for step-by-step instructions
...
4. Rules Committee certification

See [GPSA Rulebook - Certification](https://rulebook.gpsaswimming.org/officials.html#certification) for details.

### SwimTopia Setup

Ensure your team's SwimTopia registration includes the GPSA Code of Conduct agreement as a required element for parents and guardians. See [SwimTopia Guidelines](swimtopia-guidelines.md) for platform configuration.
...
| Ribbon writer | 1 |
| Runners | 2 |
| Stopwatches | 1 per lane + 1 extra (backup if using [Time Drops](time-drops-about.md)) |
| Starting horn/whistle | 1 |
| Certified Lifeguard | 1 |
| Scorekeeper table and chairs | As needed |
| Laptop/Tablet for [Meet Maestro](scorekeeper.md) | 1 |
...
- Handle any [suspended/banned individual](https://rulebook.gpsaswimming.org/conduct-of-meets.html#venue-and-code-of-conduct) situations with the other rep
...
| Laptop/Tablet for [Meet Maestro](scorekeeper.md) | Recommended |

### During the Meet

- Monitor team conduct
- Coordinate with home rep and referee on any issues
- Handle substitutions through coach ([3-event rule](https://rulebook.gpsaswimming.org/conduct-of-meets.html#substitutions) applies)
...
For complete rules, see [GPSA Rulebook - Scheduling and Postponements](https://rulebook.gpsaswimming.org/conduct-of-meets.html#scheduling-and-postponements).
...
1. First priority: agree on a date as soon as possible (e.g., next day)
2. If no immediate date, use next available league rain date
3. **Must confirm rescheduled date within 24 hours** of postponement
4. Meets after Summer Splash require Rules Committee approval
...
For complete rules, see [GPSA Rulebook - Protests](https://rulebook.gpsaswimming.org/conduct-of-meets.html#protests).

### Authority

You are the **sole representative** authorized to file a protest on behalf of your team.

### During-Meet Protests

1. File with Meet Referee **within 30 minutes** of alleged infraction
2. Referee resolves immediately (may stop meet)
...
See [GPSA Rulebook - Roster Revisions](https://rulebook.gpsaswimming.org/eligibility-and-rosters.html#roster-revisions) for complete rules.
...
See [GPSA Rulebook - Eligibility Challenges](https://rulebook.gpsaswimming.org/eligibility-and-rosters.html#eligibility-challenges) for procedures.
...
Applications and nominations are submitted **online by the applicant or nominating family** at [awards.gpsaswimming.org](https://awards.gpsaswimming.org) — you no longer collect or email them. Your role is to spread the word:

- **[J. Kyle Hurdle Scholarship](hurdle-scholarship.md):** Encourage eligible graduating seniors on your team to apply.
- **[Kei Lamberson Outstanding Coach Award](lamberson-award.md):** Let families know they can nominate your team's coach.

Both are due by **midnight, July 27** each year, and the online forms close automatically at the deadline.
...
- [Officials](https://rulebook.gpsaswimming.org/officials.html) - Roles and certification requirements
- [Conduct of Meets](https://rulebook.gpsaswimming.org/conduct-of-meets.html) - Meet procedures
- [Eligibility and Rosters](https://rulebook.gpsaswimming.org/eligibility-and-rosters.html) - Roster rules
