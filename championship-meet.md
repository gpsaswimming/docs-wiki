---
title: City Meet (Championship Meet)
toc: true
...
The date for each season is published on the [GPSA Meet Schedule](https://gpsaswimming.org/meet-schedule).
...
Current qualifying standards are listed on the [City Meet Qualifying Times](qualifying-times.md) page.
...
Warm-ups typically begin around 8:00 AM with competition starting around 9:00 AM, running through mid-afternoon. Specific warm-up lane and time assignments for each team are published in the meet invite and on the [GPSA Invitationals site](https://invitationals.gpsaswimming.org).
...
Use the **SwimTopia mobile app** — the same one you've used during the regular season — to look up your swimmer's event number, heat, and lane assignment. Results are posted in the app after each event. Note that viewing live results and heat sheets in the app requires a SwimTopia subscription (available at low cost). See [SwimTopia's guide for parents](https://help.swimtopia.com/hc/en-us/sections/360004608452-For-Parents) for setup instructions.

A heat sheet is also published on the [GPSA Invitationals site](https://invitationals.gpsaswimming.org) before the meet as a free alternative.
...
The meet location is announced each season on the [GPSA Meet Schedule](https://gpsaswimming.org/meet-schedule) and the [GPSA Invitationals site](https://invitationals.gpsaswimming.org). Once you know the venue, find the participant guide for that location:

- [Hampton Virginia Aquaplex (HVA)](hva-participant-guide.md)
...
- [City Meet Qualifying Times](qualifying-times.md)
