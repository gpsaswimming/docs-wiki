...
Welcome to the **Greater Peninsula Swimming Association (GPSA) Wiki** - your resource for league information and web tools documentation.

## What is GPSA?

The Greater Peninsula Swimming Association is a youth summer swim league serving teams across the Virginia Peninsula. Our mission is to provide a fun, competitive, and educational swimming environment for swimmers of all skill levels.
...
- [Official Times](official-times.md) - How times become official, backup timing, and the no-valid-time (NT) rule
