...
You represent the GPSA — not your home team. This guide covers the practical, meet-day work of the referee. For the official rules, see [GPSA Rulebook - Officials](https://rulebook.gpsaswimming.org/officials.html#meet-referee) and [Conduct of Meets](https://rulebook.gpsaswimming.org/conduct-of-meets.html).
...
- **Provided by:** The home team ([GPSA Representative Duties](gpsa-rep-duties.md#equipment-and-officials-to-provide)).
...
- **Have a copy of the [GPSA Rulebook](https://rulebook.gpsaswimming.org/)** with you.
...
| --- | --- |
| **[Admin Referee](https://rulebook.gpsaswimming.org/officials.html#admin-referee-optional)** (certified referee) | Primary contact for scorekeepers; processes DQ slips, the order of finish, and Place Judge Forms; handles legal substitutions |
...
The home team prepares the paperwork (see [Meet Preparation Guide](meet-preparation.md)). Before warm-ups, confirm you have:

- **[Place Judge Forms](meet-preparation.md#place-judge-forms)** — one per scoring heat (Heat 1) of events 1–56
- **[Meet Referee Sheet](meet-preparation.md#meet-referee-sheet)** — your event-by-event tracking sheet for OOF and DQ notes
- **[Meet Referee Verification of Scores](meet-preparation.md#meet-referee-verification-of-scores)** — your post-meet sign-off form
- **[Sweep Judge Sheets](meet-preparation.md#sweep-judge-sheet)** — one per sweep judge
- **DQ slips** available for the S&T judges

Confirm with the [scorekeeper](scorekeeper.md#step-3-hide-meet-score-display) that **blind scoring** is on (score display off per GPSA rules).
...
5. **The scorekeeper enters the order of finish** into Meet Maestro for Heat 1 of each scored event. See [Scorekeeper - Entering Order of Finish](scorekeeper.md#step-2-entering-order-of-finish-heat-1-only).
...
::: {.callout-important}
## The initialed Place Judge Form is the official record of the order of finish
...
4. **The slip goes to the scorekeeper,** who enters the DQ in Meet Maestro and separates the white (paperwork) and yellow (coach) copies. See [Scorekeeper - Processing DQs](scorekeeper.md#step-4-processing-disqualifications-dqs).
...
::: {.callout-warning}
## A late DQ still requires a re-rank
...
See [GPSA Rulebook - Substitutions](https://rulebook.gpsaswimming.org/conduct-of-meets.html#substitutions).
...
See [GPSA Rulebook - Protests](https://rulebook.gpsaswimming.org/conduct-of-meets.html#protests) and [GPSA Representative - Protests](gpsa-rep-duties.md#protests).
...
Before the scorekeeper locks results and the [GPSA Representative](gpsa-rep-duties.md#post-meet) transfers them, you validate the meet at the scorekeeper station. See [Scorekeeper - Referee Post-Meet Validation](scorekeeper.md#step-2-referee-post-meet-validation).

Work through every scored event (Heat 1, events 1–56) and confirm:

- [ ] **Order of finish entered for every Heat 1.** If any scoring heat has no OOF, locate its Place Judge Form and have the scorekeeper enter it before results lock.
- [ ] **Heat Place entries match the initialed Place Judge Forms** — including every DQ re-rank.
...
1. **Complete the [Meet Referee Verification of Scores](meet-preparation.md#meet-referee-verification-of-scores)** form.
...
See [GPSA Rulebook - Post-Meet Procedures](https://rulebook.gpsaswimming.org/conduct-of-meets.html#post-meet-procedures).
...
- [Officials - Meet Referee](https://rulebook.gpsaswimming.org/officials.html#meet-referee) - Role and authority
- [Conduct of Meets - Place Recording](https://rulebook.gpsaswimming.org/conduct-of-meets.html#place-recording) - Order-of-finish procedure
- [Conduct of Meets - Post-Meet Procedures](https://rulebook.gpsaswimming.org/conduct-of-meets.html#post-meet-procedures) - Validation and handoff
- [Scoring](https://rulebook.gpsaswimming.org/scoring.html) - Points, ties, and DQ place adjustments
- [Awards](https://rulebook.gpsaswimming.org/awards.html) - Ribbon and award procedures
